...
public class MapDrawer extends DefaultViewer {
	 ...
	 */
	public void draw_map(MazePanel mazePanel, int px, int py, int walk_step, int view_dx, int view_dy, boolean showMaze, boolean showSolution) {
		...
		for (int y = ymin; y <= ymax; y++)
			for (int x = xmin; x <= xmax; x++) {
				...
				mazePanel.setColor(seencells.hasWall(x,y, CardinalDirection.North) ? MazePanelColors.WHITE : MazePanelColors.GRAY);
				...
				mazePanel.setColor(seencells.hasWall(x,y, CardinalDirection.West) ? MazePanelColors.WHITE : MazePanelColors.GRAY);
