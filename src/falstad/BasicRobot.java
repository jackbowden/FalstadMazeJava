...
public class BasicRobot implements Robot {
	...
	/**
	 * Decreases battery level by a certain amount. Checks to see if battery has run out, and if so, sets hasStopped to true and the MazeController's state to STATE_FINISH, ending the game.
	 * @author jabowden and tcmzeal
