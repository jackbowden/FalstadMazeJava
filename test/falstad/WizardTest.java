...
//		assertTrue(initialBattery > robot.getBatteryLevel());
	...
	/**
	 * Tests if the wizard uses the shortest path in the maze.
	 * The maximum path length is the number of cells in the maze.
	 * @author jabowden and tcmzeal
	 */
	@Test
	public void testIfWizardUsesShortestPath() {
//		try {
//			driver.drive2Exit();
//		} catch (Exception e) {
//			e.printStackTrace();
...
//		}
//		
//		assertTrue(robot.getOdometerReading() > 0 && robot.getOdometerReading() < 16);
	}
}
